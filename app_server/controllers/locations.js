...
module.exports.homelist = function(req, res) {
	res.render('locations_list', { 
		...
		sidebar: "Looking for wife and a seat? Loc8r helps you find places to work when out and about. Perhaps with coffee, cake or a pint? Let Loc8r help you find the place you're looking for",
		locations: [{
				name: 'Starcups',
